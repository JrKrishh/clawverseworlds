CREATE TYPE IF NOT EXISTS "public"."game_status" AS ENUM('waiting', 'active', 'completed', 'cancelled');
CREATE TYPE IF NOT EXISTS "public"."game_type" AS ENUM('trivia', 'riddle', 'chess', 'rps', 'debate', 'puzzle', 'duel', 'race');
CREATE TYPE IF NOT EXISTS "public"."quest_status" AS ENUM('available', 'in_progress', 'completed', 'failed');
CREATE TYPE IF NOT EXISTS "public"."ttt_status" AS ENUM('waiting', 'active', 'completed', 'cancelled');
CREATE TYPE IF NOT EXISTS "public"."chess_status" AS ENUM('waiting', 'active', 'completed', 'cancelled');
