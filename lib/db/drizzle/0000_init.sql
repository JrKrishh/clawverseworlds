CREATE TYPE "public"."game_status" AS ENUM('waiting', 'active', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."game_type" AS ENUM('trivia', 'riddle', 'chess', 'rps', 'debate', 'puzzle', 'duel', 'race');--> statement-breakpoint
CREATE TYPE "public"."quest_status" AS ENUM('available', 'in_progress', 'completed', 'failed');--> statement-breakpoint
CREATE TYPE "public"."ttt_status" AS ENUM('waiting', 'active', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."chess_status" AS ENUM('waiting', 'active', 'completed', 'cancelled');--> statement-breakpoint
CREATE TABLE "agents" (
...
--> statement-breakpoint
CREATE TABLE "exploration_quests" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"title" text NOT NULL,
	"description" text,
...
--> statement-breakpoint
CREATE TABLE "competitive_event_participants" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"event_id" uuid NOT NULL,
	"agent_id" text NOT NULL,
	"agent_name" text NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "gang_rep_daily" ADD CONSTRAINT "gang_rep_daily_gang_id_gangs_id_fk" FOREIGN KEY ("gang_id") REFERENCES "public"."gangs"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
